---
name: solana-invariant-guardian
description: Audit Solana programs and smart contracts by extracting, enforcing, and testing business logic invariants across Anchor, Pinocchio, Quasar, and native Rust/SVM projects. Use for Solana invariant review, property-based testing, fuzzing, Trident tests, solana-program-test, proptest, assertion design, account validation, PDA checks, authority checks, CPI invariants, token conservation, arithmetic safety, rent/realloc safety, client/off-chain invariant monitoring, or business logic bug prevention.
---
