...
description: Audit and optimize project websites/apps for SEO, technical SEO, content quality, structured data, AI visibility, Generative Engine Optimization, Core Web Vitals, accessibility, crawlability, indexability, and organic discoverability. Use for SEO audit, GEO review, search visibility, metadata, sitemap, robots.txt, schema, content strategy, project docs, landing pages, or when adding missing SEO elements to a site.
---
