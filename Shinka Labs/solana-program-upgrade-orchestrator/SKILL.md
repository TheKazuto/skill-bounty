---
name: solana-program-upgrade-orchestrator
description: Plan, audit, and orchestrate safe migrations and upgrades for Solana programs and smart contracts across Anchor, Pinocchio, Quasar, and native SVM projects. Use for Solana account versioning, backward compatibility, account realloc, rent impact, migration instructions, lazy migration, batch migration, upgrade authority, multisig deployment, rollback planning, migration testing, indexer/frontend compatibility, or post-deploy monitoring.
---
