---
name: legal-audit-optimizer
description: Audit and optimize project websites/apps for legal, privacy, compliance, consumer, cookie, accessibility, and policy readiness. Use for legal audit, juridical review, privacy policy review, terms review, LGPD/GDPR/CCPA checklist, cookie consent review, or when adding missing legal elements to a project/site.
---
