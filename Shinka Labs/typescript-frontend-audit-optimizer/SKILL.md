---
name: typescript-frontend-audit-optimizer
description: Audit and optimize TypeScript frontend apps for security, XSS, token handling, runtime validation, accessibility, performance, privacy, build safety, dead code, and structural quality. Use for React, Next.js, Vue, Angular, Svelte, Vite, SPA, dashboard, frontend auth, Web Vitals, or production-readiness reviews.
---
