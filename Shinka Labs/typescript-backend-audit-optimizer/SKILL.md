---
name: typescript-backend-audit-optimizer
description: Audit and optimize TypeScript/Node.js backends for security, robustness, performance, event-loop safety, dependency risk, dead code, and structural quality. Use for TypeScript backend, Node.js API, Express, NestJS, Fastify, Hono, worker, SaaS, financial, multi-tenant, database, queue, auth, or production-readiness reviews.
---
