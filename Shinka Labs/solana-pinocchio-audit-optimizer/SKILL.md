---
name: solana-pinocchio-audit-optimizer
description: Audit and optimize Solana programs built with the Pinocchio framework for manual account validation, PDA safety, CPI security, zero-copy/unsafe soundness, SPL Token and Token-2022 behavior, arithmetic, lifecycle risks, compute units, dead code, and deployment readiness. Use for Pinocchio, pinocchio, p-token, native Solana program, no_std, process_instruction, entrypoint, AccountInfo, manual parsing, zero-copy, PDA, CPI, SPL Token, Token-2022, or low-level Sealevel security reviews.
---
